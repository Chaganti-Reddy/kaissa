...
public static class UiKit
{
    ...
    public static VisualElement NavRail(string activeScene)
    {
        ...
        rail.Add(NavItem("Guess Move", "GuessMove", activeScene));
        rail.Add(NavItem("Studies", "Studies", activeScene));
        rail.Add(NavItem("Drills", "Drills", activeScene));
        rail.Add(NavItem("Shop", "Shop", activeScene));
