...
public sealed class ScreenshotHarness : MonoBehaviour
{
    ...
    private static void Boot()
    {
        ...
        if (!args.Contains("-kaissa-shots") && !args.Contains("-kaissa-interact")
            ...
            && !args.Contains("-kaissa-stormtest") && !args.Contains("-kaissa-expeditiontest")
    ...
    private IEnumerator Start()
    {
        ...
        if (args.Contains("-kaissa-capturestest"))
        {
            SceneManager.LoadScene("Captures");
            yield return new WaitForSeconds(18f);
            Application.Quit();
            yield break;
        }

        if (args.Contains("-kaissa-visualizationtest"))
        {
        ...
        if (args.Contains("-kaissa-expeditiontest"))
        {
            SceneManager.LoadScene("Expeditions");
