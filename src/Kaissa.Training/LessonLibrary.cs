...
public sealed record Lesson(string Id, string Topic, string Title, string Intro, PatternId Pattern, int Challenges);
...
public static class LessonLibrary
{
    public static IReadOnlyList<Lesson> All { get; } = new[]
    {
        ...
        new Lesson("discovered", "Tactics", "Discovered attack",
            ...
            new PatternId("tactic.discovered_attack"), 4),
        new Lesson("deflection", "Tactics", "Deflection",
            ...
            new PatternId("tactic.deflection"), 4),
        ...
        new Lesson("smothered", "Checkmates", "Smothered mate",
            ...
            new PatternId("checkmate.smothered"), 3),
        new Lesson("matein2", "Checkmates", "Mate in two",
            ...
            new PatternId("checkmate.mate_in_two"), 4),
    };
